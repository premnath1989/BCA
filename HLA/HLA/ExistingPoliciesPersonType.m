...
//		self.items = [[NSMutableArray alloc] initWithObjects:@"1st Life Assured", @"Policy Owner", @"2nd Life Assured", nil];
		...
		if (([plan isEqualToString:@"HLACP"]) || ([plan isEqualToString:@"L100"]) || ([plan isEqualToString:@"HLAWP"]) || ([plan isEqualToString:@"HLA Cash Promise"]) || ([plan isEqualToString:@"Life100"]) || ([plan isEqualToString:@"HLA Wealth Plan"]) ){
