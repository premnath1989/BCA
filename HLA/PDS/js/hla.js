...
function setPage(){
	...
	$('.rptVersion').html('i-M Solutions Version 1.5 (Agency) - Last Updated 09 Oct 2014 - E&amp;OE-'); //set version info
...
function writeSummary1_HLCP()
{
    ...
    {
    	$('.paymentDesc').html(gdata.SI[0].SI_Temp_Trad.data[0].CashPaymentD  + '&nbsp;(Cash Dividend Payout)&nbsp;<i>' + gdata.SI[0].SI_Temp_Trad.data[0].MCashPaymentD + '&nbsp;(Dividen Tunai Dibayar)</i>');
...
function getPlanRider(riderCode)
{
    ...
    if(riderCode=='WBI6R30'||riderCode == 'WB30R'||riderCode == 'WB50R'||riderCode == 'WBD10R30'||riderCode == 'EDUWR'||riderCode == 'WP30R'||riderCode == 'WP50R'||riderCode == 'WPTPD30R'||riderCode == 'WPTPD50R')
    {
        temp = getPlanRiderHLAWP(riderCode);
    } else {
		$.each(gdata.SI[0].SI_Temp_Trad_Details.data, function(index, row) {
			if (riderCode == row.RiderCode && row.col0_1.indexOf('-') < 0){
				temp = row.col0_1;
			}
			else if (riderCode == 'ACIR_MPP')
			{
				temp = "Accelerated Critical Illness";
			}
		});
    }
...
function getPlanRiderHLAWP(riderCode)
{
	var temp;
    if (riderCode == 'WBI6R30')
    {
        temp = "Wealth Booster-<i>i6</i> Rider (30 year term)";
    }else
    if (riderCode == 'WB30R')
    {
        temp = "Wealth Booster Rider (30 year term)";
    }else
    if (riderCode == 'WB50R')
    {
        temp = "Wealth Booster Rider (50 year term)";
    }else
    if (riderCode == 'WBD10R30')
    {
        temp = "Wealth Booster-<i>d10</i> Rider (30 year term)";
    }else
    if (riderCode == 'EDUWR')
    {
        temp = "EduWealth Rider";
    }else
    if (riderCode == 'WP30R')
    {
        temp = "Wealth Protector Rider (30 year term)";
    }else
    if (riderCode == 'WP50R')
    {
        temp = "Wealth Protector Rider (50 year term)";
    }else
    if (riderCode == 'WPTPD30R')
    {
        temp = "Wealth TPD Protector Rider (30 year term)";
    }else
    if (riderCode == 'WPTPD50R')
    {
        temp = "Wealth TPD Protector Rider (50 year term)";
    }
...
function writePremiumDuration(lang)
{
	...
	{
	    if (lang == "EN")
	        $(".table-duration > tbody").append('<tr><td style="text-align:left">' + getPlanRider(gdata.SI[0].PlanCode) + '</td><td style="text-align:center">Basic Plan</td><td style="text-align:center">Life Assured</td><td style="text-align:center">' + (parseInt(LAAge) + 6) + '</td></tr>');
	    else
	        $(".table-duration > tbody").append('<tr><td style="text-align:left">' + getPlanRider(gdata.SI[0].PlanCode) + '</td><td style="text-align:center">Pelan Asas</td><td style="text-align:center">Hayat Diinsuranskan</td><td style="text-align:center">' + (parseInt(LAAge) + 6) + '</td></tr>');
        
	}
	else if(gdata.SI[0].PlanCode == "HLAWP")
	{
	    if (lang == "EN")
	        $(".table-duration > tbody").append('<tr><td style="text-align:left">' + getPlanRider(gdata.SI[0].PlanCode) + '</td><td style="text-align:center">Basic Plan</td><td style="text-align:center">Life Assured</td><td style="text-align:center">' +
						    premiumPayableUntill + '</td></tr>');
	    else
	        $(".table-duration > tbody").append('<tr><td style="text-align:left">' + getPlanRider(gdata.SI[0].PlanCode) + '</td><td style="text-align:center">Pelan Asas</td><td style="text-align:center">Hayat Diinsuranskan</td><td style="text-align:center">' +
						    premiumPayableUntill + '</td></tr>');    
	}
	else if(gdata.SI[0].PlanCode == "S100" || gdata.SI[0].PlanCode == "L100")
	{
	   if (lang == "EN")
	       $(".table-duration > tbody").append('<tr><td style="text-align:left">' + getPlanRider(gdata.SI[0].PlanCode) + '</td><td style="text-align:center">Basic Plan</td><td style="text-align:center">Life Assured</td><td style="text-align:center">100</td></tr>');
	   else
	       $(".table-duration > tbody").append('<tr><td style="text-align:left">' + getPlanRider(gdata.SI[0].PlanCode) + '</td><td style="text-align:center">Pelan Asas</td><td style="text-align:center">Hayat Diinsuranskan</td><td style="text-align:center">100</td></tr>');
	}
	...
	if(gdata.SI[0].PlanCode == "HLAWP")
	{
		$.each(gdata.SI[0].Trad_Rider_Details.data, function(index, Trad_Rider_Details) {
			...
			{
				//var RiderDuration = Trad_Rider_Details.RiderTerm;
...
//     });
//     
// 	var riderCount = gdata.SI[0].Trad_Rider_Details.data.length;
// 	
// 	temp = estimateCount + riderCount;
// 	if (temp <=20){
...
function writeAttachingRider_1(lang)
{
	...
	$.each(gdata.SI[0].SI_Temp_Pages_PDS.data, function(index, row) {
	       ...
	       else
	       {
			if(textExist == false){
				if (lang == "EN"){
					$("#" + row.PageDesc + " .showOnlyAtFirstPage").html('<u><b>Attaching Rider(s)</u></b>');	
				}
				else{
					$("#" + row.PageDesc + " .showOnlyAtFirstPage").html('<u><b>Rider yang Dilampirkan</u></b>');	
				}
...
/*
 <tr>
 <td style="padding: 1px 0px 1px 5px;vertical-align: text-op">Living Care Waiver Of Premium Payor Rider (110%)</td>
...
function writeCancel(lang)
{
	...
	$.each(gdata.SI[0].Trad_Rider_Details.data, function(index, Trad_Rider_Details) {
           ...
           //PremiumDurationCount++;
           //$(".table-duration > tbody").append('<tr><td style="text-align:left">' + getPlanRider(Trad_Rider_Details.RiderCode) + '</td><td style="text-align:center">Rider</td><td style="text-align:center">' + Insured(Trad_Rider_Details.PTypeCode, Trad_Rider_Details.Seq) + '</td><td style="text-align:center">' + (parseInt(LAAge) + parseInt(Trad_Rider_Details.RiderTerm)) + '</td></tr>');
           ...
           temp = descBM[2];
           $(".table-Cancel > tbody").append('<tr><td style="padding: 0px 0px 0px 5px;">' + getPlanRider(Trad_Rider_Details.RiderCode) + '</td><td style="padding: 0px 0px 0px 5px;">' + temp + '</td></tr>')
           }
...
function setPageDesc(page){
	$('#rptVersion').html('iMP Version 1.2 (Agency) - Last Updated 03 Oct 2014 - E&amp;OE-');
