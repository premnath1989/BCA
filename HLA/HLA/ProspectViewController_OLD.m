...
- (bool) Validation{
    ...
    if(![txtEmail.text isEqualToString:@""]){
        if( [self NSStringIsValidEmail:txtEmail.text] == FALSE){
            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@" "
                                                            message:@"You have entered an invalid email. Please key in the correct email." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
    ...
    if([[txtHomeAddr1.text stringByReplacingOccurrencesOfString:@" " withString:@"" ] isEqualToString:@""]){
        if(![[txtHomePostCode.text stringByReplacingOccurrencesOfString:@" " withString:@"" ] isEqualToString:@""]){
            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@" "
                                                            message:@"Residential Address is required." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
    ...
    if (PostcodeContinueOLD == TRUE) {
        if(![[txtHomeAddr1.text stringByReplacingOccurrencesOfString:@" " withString:@"" ] isEqualToString:@""]){
            if([txtHomePostCode.text isEqualToString:@""]){
                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@" "
                                                                message:@"Residential Address PostCode is required" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
...
-(void)textFieldDidChange:(id) sender
{
	...
	if (!valid) {
		...
		if (sqlite3_open(dbpath, &contactDB) == SQLITE_OK){
			...
			if (gotRow == false) {
				/*
				 UIAlertView *NoPostcode = [[UIAlertView alloc] initWithTitle:@" " message:@"No postcode found for Home Address"
				...
				rrr = [[UIAlertView alloc] initWithTitle:@" " message:@"No postcode found for Home Address"
												delegate:self cancelButtonTitle:@"OK" otherButtonTitles: nil];
...
-(void)OfficePostcodeDidChange:(id) sender
{
    ...
    if ([txtOfficePostcode.text isEqualToString:@""]) {
        /*
		 UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@" " message:@"Office postcode is required"
		 delegate:self cancelButtonTitle:@"OK" otherButtonTitles: nil];
		 alert.tag = 3001;
		 [alert show];*/
        rrr = [[UIAlertView alloc] initWithTitle:@" " message:@"Office postcode is required"
										delegate:self cancelButtonTitle:@"OK" otherButtonTitles: nil];
        rrr.tag = 3001;
        [rrr show];
        return;
	...
	if (!valid) {
		...
		if (sqlite3_open(dbpath, &contactDB) == SQLITE_OK){
			...
			if (sqlite3_prepare_v2(contactDB, query_stmt, -1, &statement, NULL) == SQLITE_OK)
			{
				...
				if (gotRow == false) {
					/*UIAlertView *NoPostcode = [[UIAlertView alloc] initWithTitle:@" " message:@"No postcode found for office"
					 delegate:self cancelButtonTitle:@"OK" otherButtonTitles: nil];
					 
					 NoPostcode.tag = 3000;
					 [NoPostcode show];*/
					rrr = [[UIAlertView alloc] initWithTitle:@" " message:@"No postcode found for office"
													delegate:self cancelButtonTitle:@"OK" otherButtonTitles: nil];
