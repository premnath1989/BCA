 ...
 * Module: SPSignWare.h                                         *
 * Created by: uko                                              *
 * Version: $Name: RST#SignWare#core#REL-3-0-1-9 $                                            *
 *                                                              *
...
SPEXTERN SPINT32 SPLINK SPSignwareGetBrowserTicket(const SPCHAR *pszRequestUrl, pSPTICKET_T pTicket, SPCHAR **ppszTicket);
 ...
 /*
  * $Log: SPSignWare.h,v $
  * Revision 1.35.2.9.4.1  2013/12/05 12:50:32  ema
  * Version 3.0.1.9 is just version 3.0.0.9 with version number 3.0.1.9.
  *
  * Revision 1.35.2.9  2013/04/03 10:19:06  uko
  * *** empty log message ***
  *
  * Revision 1.35.2.8  2013/03/22 17:05:50  uko
  * BugFix: Cannot compare dyn signature against static reference
  *
